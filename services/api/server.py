                ...
                "get": {
                    ...
                    "parameters": [
                        ...
                        },
                        {
                            ...
                            "description": "Shared Monday-based reporting period for the chart and activity table. Ignored when chartStart/chartEnd are provided.",
                        },
                        {
                            "name": "chartStart",
                            "in": "query",
                            "schema": {"type": "string", "format": "date"},
                            "description": "Inclusive custom reporting-period start for the chart and activity table; requires chartEnd.",
                        },
                        {
                            "name": "chartEnd",
                            "in": "query",
                            "schema": {"type": "string", "format": "date"},
                            "description": "Inclusive custom reporting-period end; requires chartStart and cannot be after today.",
                        },
                        {
                            "name": "tableWindowWeeks",
                            "in": "query",
                            "deprecated": True,
                            "schema": {"type": "integer", "enum": [1, 2, 4, 12]},
                            "description": "Legacy activity-table override. Omit to use the shared reporting period.",
                        },
                        {
                            "name": "activity",
                            "in": "query",
            ...
            if path == "/api/initiative-deep-dive":
                ...
                try:
                    payload = initiative_deep_dive_provider(
                        ...
                        table_window_weeks=query.get("tableWindowWeeks", [None])[0],
